        ...
        <div className="what grid md:grid-cols-2 justify-evenly my-5 mx-0">
            <div className="show flex py-5" data-aos="zoom-in-up">
                ...
                <div className="do pl-4">
                    <h4 className='mb-3 text-gray-700 font-bold tracking-wide'>Design</h4>
                    <p className='text-sm text-gray-500'>Designing a product is my favourite activity. I like to explore and get inspired,
            ...
            <div className="show flex py-5" data-aos="zoom-in-up">
                ...
                <div className="do pl-4">
                    <h4 className='mb-3 text-gray-700 font-bold tracking-wide'>Development</h4>
            ...
            <div className="show flex py-5" data-aos="zoom-in-up">
                ...
                <div className="do pl-4">
                    <h4 className='mb-3 text-gray-700 font-bold tracking-wide'>E-commerce</h4>
                    <p className='text-sm text-gray-500'>
            ...
            <div className="show flex py-5" data-aos="zoom-in-up">
                ...
                <div className="do pl-4">
                    <h4 className='mb-3 text-gray-700 font-bold tracking-wide'>App / Portfolio</h4>
                    <p className='text-sm text-gray-500'>
